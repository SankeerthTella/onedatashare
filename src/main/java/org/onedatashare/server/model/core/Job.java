...
public class Job {
    ...
    private TransferRequest.SourceInfo sourceInfo;
    private TransferRequest.DestinationInfo destinationInfo;
    ...
    public Job(TransferRequest.SourceInfo sourceInfo, TransferRequest.DestinationInfo destinationInfo){
